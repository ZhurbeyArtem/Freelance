...
export class BidFix1686598875752 implements MigrationInterface {
    name = 'BidFix1686598875752'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`bid\` DROP COLUMN \`attachment\``);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`notification\` CHANGE \`complaintMessage\` \`complaintMessage\` varchar(255) NULL`);
        await queryRunner.query(`ALTER TABLE \`tags\` CHANGE \`name\` \`name\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`bid\` ADD \`attachment\` varchar(255) NOT NULL`);
    }
